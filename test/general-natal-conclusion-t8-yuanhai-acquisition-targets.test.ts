  ...
  it('pins the NDL microform holding without treating it as physical-original or phrase-level evidence', () => {
    ...
    expect(ndl).toMatchObject({
      ...
      reproductionAccess: {
        ...
        articleLocationResearchServiceAvailableGenerally: true,
        targetEligibilityForArticleLocationResearch: 'NOT_ESTABLISHED',
        articleLocationResearchScope: 'TABLE_OF_CONTENTS_OR_INDEX_ONLY',
