...
export const R063_CONFIGURATION_EXAMPLES = Object.freeze([
  {
    id: 'SANMING_V7_DAY_SEAT_WEALTH_SPOUSE_EXAMPLE',
    sourceStratum: 'SANMING_TONGHUI_VOLUME_7_LIUQIN',
    sourceSurface: '日坐命財更在財生旺之鄉主得妻財又主妻賢明',
    domain: 'SPOUSE_CONFIGURATION',
    daySeatSpecific: true,
    generalizedSpouseOutcomeAuthorized: false,
    executable: false,
  },
  {
    id: 'SANMING_V2_DINGZHEN_DAY_WIFE_EXAMPLE',
    sourceStratum: 'SANMING_TONGHUI_SIKU_VOLUME_2_DINGZHENLUN',
    sourceSurface: '或日為妻如在空刑克煞之地言克妻妾之斷',
    domain: 'SPOUSE_CONFIGURATION',
    daySeatSpecific: false,
    generalizedSpouseOutcomeAuthorized: false,
    executable: false,
  },
] as const);
