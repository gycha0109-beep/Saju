...
export function buildGeneralNatalConclusionT8PromotionProvenanceTrustReadiness() {
  ...
  // The candidate registry binds no concrete review attestations and no external reviewer trust
  // context. Trust infrastructure elsewhere in the repository is not authority for this bundle.
  ...
  const material = {
    ...
    issue: '#730' as const,
    auditBaseSha: '5c2a68eff77620ac4b2bc0892d9847efb746940e' as const,
