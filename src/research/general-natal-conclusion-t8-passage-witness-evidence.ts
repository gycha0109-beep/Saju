...
export const GENERAL_NATAL_CONCLUSION_T8_PASSAGE_WITNESS_VERSION =
  'myeonghwa-general-natal-conclusion-t8-passage-witness-v1' as const;
...
interface PassageWitness {
  ...
  readonly sourceQualification: 'QUALIFIED_CLASSICAL_EDITION_TRANSCRIPTION' | 'IMMUTABLE_BUT_SOURCE_INTEGRITY_LIMITED';
}
...
const PASSAGE_WITNESSES = Object.freeze({
  YUANHAI_PEER: {
    ...
    proposition: 'The same-kind Ten-God side includes peer/rob-wealth categories for the day master.',
  ...
  YUANHAI_OFFICER_RESOURCE: {
    ...
    proposition: 'Traditional text directly links the killing/officer side to resource through transformation into resource.',
    sourceQualification: 'IMMUTABLE_BUT_SOURCE_INTEGRITY_LIMITED',
  },
  YUANHAI_PEER_WEALTH: {
    ...
    proposition: 'Traditional text treats peer/rob-wealth presence as adverse to a wealth configuration.',
    sourceQualification: 'IMMUTABLE_BUT_SOURCE_INTEGRITY_LIMITED',
  },
  ...
  SAMYEONG_TAXONOMY: {
    ...
    permanentRevisionUrl: SAMYEONG_REVISION_URL,
    section: '論古人立印食官財名義',
...
const RULE_WITNESS_KEYS = Object.freeze({
  'RULE-GENERAL-NATAL-CONCLUSION-FAMILY-PEER-PRESENT': ['YUANHAI_PEER', 'SAMYEONG_TAXONOMY'],
...
export function buildGeneralNatalConclusionT8PassageWitnessEvidence() {
  ...
  const boundRules = Object.freeze(
    Object.entries(RULE_WITNESS_KEYS).map(([ruleId, witnessKeys]) => {
      ...
      return Object.freeze({
        ...
        witnessSourceIds: Object.freeze([...new Set(witnesses.map((witness) => witness.sourceId))].sort()),
  ...
  const material = {
    ...
    issue: '#772' as const,
    auditBaseSha: 'a5cabffb6067fba26934e18d088229a6cc8f2ee2' as const,
