...
export const R077_ROLE_STATES = Object.freeze([
  {
    ...
    sourceRepresentation: '命中喜神或用神',
    provenanceKind: 'DIRECT_QUOTE_EXCERPT',
    automaticTemporalReselection: false,
    executable: false,
  },
  {
    state: 'LUCK_SUPPORT_OR_OPPOSITION',
    sourceRepresentation: '行運助之 / 行運抑之',
  ...
  },
  {
    ...
    sourceRepresentation: '成格變格 distinct from ordinary 助用害用',
    provenanceKind: 'BOUNDED_RESEARCH_ABSTRACTION',
    automaticTemporalReselection: false,
    executable: false,
  },
] as const);
