export const R121_ROOT_STRENGTH_DEPENDENCY_MAP_VERSION = '0.2.0-research' as const;
...
export type R121R011Dependency =
  | 'NOT_REQUIRED'
...
export interface R121StrengthDependencyRow {
  ...
  r011Dependency: R121R011Dependency;
  ...
  Object.freeze([
    {
      ...
      capability:
        'Use month branch / month command as an important bounded strength context without making it exclusive authority.',
    ...
    },
    {
      ...
      capability:
        'Recognize already-governed positive Tonggen observations in their exact bounded source scopes.',
      researchState: 'SUPPORTED_BOUNDED',
      disposition: 'AUTHORITY_REVIEW_REQUIRED',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
    ...
    },
    {
      ...
      capability:
        'Decide globally that a stem has no Tonggen/root across all branches and source scopes.',
    ...
    },
    {
      ...
      capability:
        'Recognize bounded non-Earth applicable 墓庫 positive root/Tonggen evidence.',
      researchState: 'SUPPORTED_BOUNDED',
      disposition: 'AUTHORITY_REVIEW_REQUIRED',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
    ...
    },
    {
      ...
      capability:
        'Recognize already-governed non-Earth 餘氣 positive bounded Tonggen evidence.',
      researchState: 'SUPPORTED_BOUNDED',
      disposition: 'AUTHORITY_REVIEW_REQUIRED',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
    ...
    },
    {
      ...
      capability:
        'Turn 餘氣 temporal variability into a temporal weight or executable strength classifier.',
      researchState: 'PARTIAL',
      disposition: 'BLOCKED_BY_OTHER_RESEARCH',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
      otherResearchDependencies: [
        'R015_EXECUTABLE_TEMPORAL_CLASSIFIER_UNAUTHORIZED',
      ],
      evidenceRefs: [
        'R015',
    ...
    },
    {
      ...
      capability:
        'Recognize governed Yang 長生 as bounded positive root/Tonggen evidence.',
      researchState: 'SUPPORTED_BOUNDED',
      disposition: 'AUTHORITY_REVIEW_REQUIRED',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
    ...
    },
    {
      ...
      capability:
        'Preserve bounded 祿 and 旺 heavy-root / Tonggen-positive observations.',
      researchState: 'SUPPORTED_BOUNDED',
      disposition: 'AUTHORITY_REVIEW_REQUIRED',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
    ...
    },
    {
      ...
      capability:
        'Equate Twelve-Growth 臨官/帝旺 stages with executable 祿/旺 heavy-root classes across source authorities.',
    ...
    },
    {
      ...
      capability:
        'Use already-governed 比劫/比肩 observations as bounded support-constituent evidence.',
      researchState: 'SUPPORTED_BOUNDED',
      disposition: 'AUTHORITY_REVIEW_REQUIRED',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
    ...
    },
    {
      ...
      capability:
        'Aggregate 比劫/印綬/通根 support into chart-level 黨眾/助寡 settlement.',
      researchState: 'PARTIAL',
      disposition: 'BLOCKED_BY_OTHER_RESEARCH',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
    ...
    },
    {
      ...
      capability:
        'Preserve that 得時 alone need not imply 旺 and 失時 alone need not imply 弱.',
      researchState: 'SUPPORTED_BOUNDED',
      disposition: 'AUTHORITY_REVIEW_REQUIRED',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
    ...
    },
    {
      ...
      capability:
        'Resolve canonical 四柱有根 / 無根 across all relevant stems, branches, and source scopes.',
      researchState: 'UNRESOLVED',
      disposition: 'BLOCKED_BY_OTHER_RESEARCH',
      r011Dependency: 'SATISFIED_PREREQUISITE',
      r011NecessaryButNotSufficient: true,
      ...
      prohibitedExtensions: [
        ...
        'R011_CLOSURE_EQUALS_COMPLETE_SIZHU_RESOLVER',
      ],
    },
    {
      capabilityId: 'FINAL_WHOLE_CHART_QIANG_RUO_CLASSIFIER',
      capability:
        'Emit a final whole-chart 強弱/旺衰 classification from season, root, support, opposition, and methodology composition.',
      researchState: 'UNRESOLVED',
      disposition: 'BLOCKED_BY_OTHER_RESEARCH',
      r011Dependency: 'SATISFIED_PREREQUISITE',
      r011NecessaryButNotSufficient: true,
    ...
    },
    {
      ...
      capability:
        'Assign a universal numeric strength/root score or hidden weighting system.',
      researchState: 'NOT_SUPPORTED',
      disposition: 'NOT_AUTHORIZED',
      r011Dependency: 'NOT_REQUIRED',
      r011NecessaryButNotSufficient: false,
...
export const R121_DISPOSITION_RULES = Object.freeze([
  'R011_DIRECT_VISUAL_CLOSURE_SATISFIES_THE_CROSS_SOURCE_ROOT_SEMANTIC_PREREQUISITE',
  'R011_CLOSURE_DOES_NOT_CREATE_A_GLOBAL_NEGATIVE_ROOT_RESOLVER',
  'R011_CLOSURE_DOES_NOT_CREATE_A_COMPLETE_SIZHU_ROOT_RESOLVER',
  'R011_CLOSURE_DOES_NOT_CREATE_A_FINAL_STRENGTH_CLASSIFIER',
  'BOUNDED_POSITIVE_EVIDENCE_REMAINS_SOURCE_SCOPED_AFTER_R011_CLOSURE',
...
export const R121_SUMMARY = Object.freeze({
  ...
  r011SatisfiedPrerequisiteRowIds: R121_STRENGTH_DEPENDENCY_ROWS.filter(
    (row) => row.r011Dependency === 'SATISFIED_PREREQUISITE',
  ).map((row) => row.capabilityId),
  currentlyBlockedByR011RowIds: R121_STRENGTH_DEPENDENCY_ROWS.filter(
    (row) => row.disposition === 'BLOCKED_BY_R011',
  ).map((row) => row.capabilityId),
  blockedByOtherResearchRowIds: R121_STRENGTH_DEPENDENCY_ROWS.filter(
    (row) => row.disposition === 'BLOCKED_BY_OTHER_RESEARCH',
  ).map((row) => row.capabilityId),
...
export const R121_AUTHORITY = Object.freeze({
  status: 'RESEARCH_DEPENDENCY_MAP_CANDIDATE_POST_R011_CLOSURE' as const,
  researchOnly: true,
  r011ClosureMergeSha:
    '0eaf5eae84aebfde142d68651418537ffe620098' as const,
