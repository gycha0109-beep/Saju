...
const BUSINESS_CONCLUSIONS: readonly BusinessConclusionSpec[] = [
  ...
  },
  {
    ...
    summary:
      '무작정 뛰어들기보다 시장이나 조건을 이해하고 필요한 정보를 확인한 뒤 움직일 때 심리적으로 안정되기 쉽습니다. 다만 완전히 확실해질 때까지 기다리려 하면 결정 시점을 놓칠 수 있어 무엇까지 확인하면 실행할지 기준을 정해두는 편이 도움이 됩니다.',
  },
  {
    id: 'OUTPUT-TEST-BY-DOING',
    kind: 'decision_execution',
    families: ['output'],
    headline: '계속 검토만 하기보다 작게라도 만들어 반응을 확인할 때 판단이 빨라질 수 있습니다',
    summary:
      '아이디어를 머릿속에서 오래 굴리는 것보다 시제품, 제안, 판매 페이지처럼 실제로 꺼내보고 반응을 보는 방식이 더 잘 맞을 수 있습니다. 직접 해본 결과가 다음 판단의 근거가 되기 때문에 실행과 수정의 반복이 중요해질 수 있습니다.',
  },
  {
    ...
    summary:
      '사업에서는 하고 싶은 일의 수보다 제한된 자원을 어디에 먼저 넣을지가 중요해집니다. 비용이나 노력의 크기만 보기보다 지금 무엇에 투입해야 실제 반응이나 성과를 확인할 수 있는지를 기준으로 우선순위를 잡는 방식이 잘 맞을 수 있습니다.',
  },
  {
    ...
    summary:
      '누가 무엇을 결정하고 어디까지 책임지는지 애매한 상태가 길어지면 피로가 커질 수 있습니다. 작은 팀이라도 승인 기준, 마감, 품질 기준처럼 최소한의 운영 규칙을 분명히 해두면 책임을 맡고 지속적으로 관리하기가 더 쉬울 수 있습니다.',
  },
  {
    ...
    summary:
      '무엇을 만들었는지 자체보다 고객 반응, 사용 여부, 구매 같은 현실의 피드백이 들어올 때 다음 행동을 정하기 쉬울 수 있습니다. 반응이 없는데도 계속 만드는 것보다 작은 결과를 확인하면서 방향을 바꾸는 운영이 더 자연스러울 수 있습니다.',
  },
  {
  ...
  },
  {
    ...
    summary:
      '각자 자기 방식대로 움직이고 싶은 성향과 역할 기준을 분명히 하고 싶은 성향이 함께 나타날 수 있습니다. 공동사업에서는 누가 어떤 결정을 단독으로 할 수 있는지, 합의가 필요한 영역은 무엇인지 미리 정해두면 힘겨루기와 책임 떠넘기기를 줄이는 데 도움이 됩니다.',
  },
  {
  ...
  },
  {
    ...
    headline: '내가 밀고 싶은 방향과 시장에서 실제로 먹히는 선택이 다를 때 갈등이 커질 수 있습니다',
    summary:
