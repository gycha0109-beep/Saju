...
export const R080_CASES = Object.freeze([
  {
    ...
    birthChronologyEvidence: 'CORROBORATED_BIOGRAPHICAL_RECORDS_NOT_PRIMARY_BIRTH_RECORD',
    eventChronologyEvidence: 'CONTEMPORANEOUS_US_DIPLOMATIC_RECORDS',
  ...
  },
  {
    ...
    birthChronologyEvidence: 'INSUFFICIENT_FOR_EXACT_DAYUN_START',
    eventChronologyEvidence: 'INSUFFICIENT_FOR_CLEAN_EXACT_YEAR_BACKTEST',
