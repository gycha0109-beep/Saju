...
import {
  analyzeControlledCaptureGeometrySensitivityFR269,
} from '../.face-reading-dist/observable-morphology-controlled-capture-geometry-sensitivity-fr269.js';

const ROOT = new URL('../research/face-reading/evidence/fr269-controlled-geometry/', import.meta.url);
const EVIDENCE = Object.freeze([
  Object.freeze({
    condition: 'baseline_eye_level',
    sourceRef: 'repo:research/face-reading/evidence/fr269-controlled-geometry/baseline-eye-level.fr257.json',
    file: new URL('baseline-eye-level.fr257.json', ROOT),
  }),
  Object.freeze({
    condition: 'low_angle',
    sourceRef: 'repo:research/face-reading/evidence/fr269-controlled-geometry/low-angle.fr257.json',
    file: new URL('low-angle.fr257.json', ROOT),
  }),
  Object.freeze({
    condition: 'high_angle',
    sourceRef: 'repo:research/face-reading/evidence/fr269-controlled-geometry/high-angle.fr257.json',
    file: new URL('high-angle.fr257.json', ROOT),
  }),
]);
const REPORT_FILE = new URL('controlled-geometry-sensitivity-report.fr269.json', ROOT);
...
const report = analyzeControlledCaptureGeometrySensitivityFR269({
...
if (process.argv.includes('--verify')) {
  ...
  process.stdout.write(
    'FR269 controlled geometry sensitivity report verified: '
