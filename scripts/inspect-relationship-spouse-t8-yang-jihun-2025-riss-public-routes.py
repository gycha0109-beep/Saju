...
AUTHOR='양지훈'
TITLE_SIGNALS=('명리학 곤명','연해자평')
EXPECTED_CONTROL='a0a78b8578ab695effe0bdc3ef48d419'
EXPECTED_MAT='be54d9b8bc7cdb09'
EXPECTED_SUBMAT='f1a8c7a1de0e08b8'
EXPECTED_KIND='a8cb3aaead67ab5b'
EXPECTED_RISS_ID='T17159723'
EXPECTED_UCI='I804:44032-200000847815'
UA='Mozilla/5.0 (compatible; SajuResearchEvidence/1.0; Yang-Jihun-2025-public-routes)'
...
assert AUTHOR in t and all(sig in t for sig in TITLE_SIGNALS) and '2025' in t
assert EXPECTED_RISS_ID in t and EXPECTED_UCI in t
...
assert doc_control=='17159723',doc_control
...
out={
 ...
 'exactRow':{'control':EXPECTED_CONTROL,'rissId':EXPECTED_RISS_ID,'uci':EXPECTED_UCI,'formTuple':form_tuple},
