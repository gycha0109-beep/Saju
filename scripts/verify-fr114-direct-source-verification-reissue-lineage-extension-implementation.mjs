...
import {
  implementDirectSourceVerificationReissueLineageExtensionFR114,
  validateDirectSourceVerificationReissueLineageExtensionImplementationFR114,
} from '../.face-reading-dist/direct-source-verification-reissue-lineage-extension-implementation-fr114.js';
...
const fr66 = await runPhotoToLipsContourNeutralSurfaceFR66({
  ...
  providerRunRef: 'fr114:exact-verifier',
...
validateDirectSourceVerificationReissueLineageExtensionImplementationFR114(fr114);

if (
  fr114.authorityState !== 'core_registry_relation_extension_implemented_reissue_still_not_authorized' ||
  fr114.implementation.registryRelationFieldName !== 'verificationRelations' ||
  fr114.implementation.registryRelationFieldOptional !== true ||
  fr114.implementation.pageRecordInlineLineageAdded !== false ||
  fr114.implementation.legacyRegistryObjectShapePreserved !== true ||
  fr114.implementation.boundedCoreRelationValidationPassed !== true ||
  fr114.implementation.singleParentPerChildEnforced !== true ||
  fr114.implementation.singleHopParentRootEnforced !== true ||
  fr114.implementation.exactEvidenceReuseEnforced !== true ||
  fr114.implementation.sameCheckingEventEnforced !== true ||
  fr114.implementation.independentVerificationDeltaFixedAtZero !== true ||
  fr114.implementation.childMayCountAsIndependentVerification !== false ||
  fr114.implementation.coreExtensionImplemented !== true ||
  fr114.implementation.targetRelationPersisted !== false ||
  fr114.implementation.targetReissueRecordPersisted !== false ||
  fr114.execution.directSourceRegistrySchemaChanges !== 1 ||
  fr114.execution.coreRelationValidatorImplemented !== true ||
  fr114.execution.verificationRelationsPersisted !== 0 ||
  fr114.execution.verificationRecordsReissued !== 0 ||
  fr114.execution.verificationRecordsPersisted !== 0 ||
  fr114.execution.passagesPersisted !== 0 ||
  fr114.execution.methodologySourceRefsRewritten !== 0 ||
  fr114.execution.metricBindingsIssued !== 0 ||
  fr114.execution.thresholdsIssued !== 0 ||
  fr114.execution.criterionStatesIssued !== 0 ||
  fr114.execution.claimsIssued !== 0 ||
  fr114.execution.traditionalSemanticAuthority !== false ||
  fr114.recommendedNextFrontier !== 'intake_witness_qualified_page_verification_reissue_post_lineage_admission_review'
) throw new Error('FR114 exact lineage-extension implementation authority drift.');

process.stdout.write(`${JSON.stringify({
  status: 'FR114_DIRECT_SOURCE_VERIFICATION_REISSUE_LINEAGE_EXTENSION_IMPLEMENTATION_PASS',
  authorityState: fr114.authorityState,
  coreExtensionImplemented: fr114.implementation.coreExtensionImplemented,
  directSourceRegistrySchemaChanges: fr114.execution.directSourceRegistrySchemaChanges,
  coreRelationValidatorImplemented: fr114.execution.coreRelationValidatorImplemented,
  verificationRelationsPersisted: fr114.execution.verificationRelationsPersisted,
  verificationRecordsPersisted: fr114.execution.verificationRecordsPersisted,
  passagesPersisted: fr114.execution.passagesPersisted,
  traditionalSemanticAuthority: fr114.execution.traditionalSemanticAuthority,
  nextFrontier: fr114.recommendedNextFrontier,
})}\n`);
