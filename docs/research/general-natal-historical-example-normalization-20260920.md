...
| YUAN-SHIKAI-MAO-LUCK | SOURCE_PROVIDED_CHART + PARTIAL_BIRTH_DATA | chart `己未 癸酉 丁巳 丁未`; corroborated biographical date `1859-09-16`, not a primary birth record | no exact four-pillar reproduction |
| LI-GUOJIE-WEI-JIAXU | PARTIAL_BIRTH_DATA | exact independent birth timestamp not secured; no source chart is promoted into this manifest | no |
...
R080 provenance alignment: Yuan's 1859-09-16 date is retained as corroborated biographical chronology, not upgraded to a primary birth record or calculator-ready `INDEPENDENT_BIRTH_DATA`. Li remains insufficient for exact Dayun-start reproduction.
